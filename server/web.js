module.exports = function (application, domain = 'localhost', port = 3000, public_src = "./", filepath = '../') {
...
//var FileList = [];
    const indexRouter = require(filepath + 'routes');
    const batRouter = require(filepath + 'routes/bat');
// var batqRouter = require('./routes/batq');
    const projectRouter = require(filepath + 'routes/project');
...
// view engine setup
    web.set('views', path.join(__dirname, filepath + 'views'));
